...
class BertEmbeddings(nn.Module):
    ...
    def forward(
        ...
        if inputs_first_embeds is not None:
            input_shape = input_shape[0], input_shape[1] + inputs_first_embeds.shape[1]
        ...
        if inputs_first_embeds is not None:
            inputs_embeds = torch.concatenate([inputs_first_embeds, inputs_embeds], dim=1)
...
class MixBertModel(BertPreTrainedModel):
    """
