...
The immediate successor thread includes full-attention [NeoBERT](bert-modern-encoder_2025_neobert.md), paired encoder/decoder [Ettin](https://arxiv.org/abs/2507.11412), massively multilingual [mmBERT](https://arxiv.org/abs/2509.06888), and multilingual [EuroBERT](https://arxiv.org/abs/2503.05500). NeoBERT's local review is available; the BERT overview tracks the remaining reviews.
...
- **Related / successor papers:** [NeoBERT](bert-modern-encoder_2025_neobert.md) · [Ettin / Seq vs Seq](https://arxiv.org/abs/2507.11412) · [mmBERT](https://arxiv.org/abs/2509.06888) · [EuroBERT](https://arxiv.org/abs/2503.05500)
