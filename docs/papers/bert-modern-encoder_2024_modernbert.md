...
The immediate successor thread includes full-attention [NeoBERT](bert-modern-encoder_2025_neobert.md), paired encoder/decoder [Ettin](bert-modern-encoder_2025_ettin-seq-vs-seq.md), massively multilingual [mmBERT](bert-modern-encoder_2025_mmbert.md), and multilingual [EuroBERT](bert-modern-encoder_2025_eurobert.md). Local reviews are available for all four.
...
- **Related / successor papers:** [NeoBERT](bert-modern-encoder_2025_neobert.md) · [Ettin / Seq vs Seq](bert-modern-encoder_2025_ettin-seq-vs-seq.md) · [mmBERT](bert-modern-encoder_2025_mmbert.md) · [EuroBERT](bert-modern-encoder_2025_eurobert.md)